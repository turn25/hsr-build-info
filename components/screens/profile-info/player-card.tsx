...
const PlayerCardRecord = (props: PlayerCardRecordProps) => {
  ...
  return (
    <div className='relative'>
      ...
      <span
        aria-hidden
        className='absolute bottom-1.5 left-0 px-2 text-[8px] font-bold opacity-50'
      >
        乃尺ひん
      </span>
    </div>
    ...
    <div className='relative flex flex-col items-center'>
      <div className='absolute inset-0 -z-1 overflow-hidden rounded-ss-3xl bg-[#45423d]'>
        <Image
          ...
          alt='avatar frame bg'
          width={300}
          className='h-full w-full scale-[108%] object-cover opacity-75'
        />
      </div>
...
const PlayerCard = (props: PlayerCardProps) => {
  ...
  return (
    <div className={cn('relative flex w-full shrink-0 flex-col', className)}>
